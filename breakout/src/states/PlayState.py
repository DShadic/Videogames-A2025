...
class PlayState(BaseState):
    def enter(self, **params: dict):
        ...
        self.score_multiplier = 1  # Inicialmente, los puntos no están multiplicados
        self.multiplier_end_time = None  # No hay un tiempo de expiración aún
    ...
    def update(self, dt: float) -> None:
        ...
        for ball in self.balls:
            ...
            brick.hit()
            self.score += brick.score() * self.score_multiplier  # Ahora usa el multiplicador
            ...
            if random.random() < 1:
                ...
                if random.random() < 0.4:  # 50% para cada uno
        ...
        if self.multiplier_end_time and time.time() > self.multiplier_end_time:
            self.score_multiplier = 1  # Restablecer el multiplicador a 1
